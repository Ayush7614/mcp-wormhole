...
POSTERS = [
    ...
    },
    {
        ...
        "badge": "v0.2.0 LIVE",
        "client_logo": "site/public/logos/asana.svg",
        "tool_name": "Asana MCP",
        "tool_logo": "site/public/logos/asana.svg",
    ...
    },
    {
        ...
        "badge": "v0.2.0 LIVE",
        "client_logo": "site/public/logos/vercel.png",
    ...
    {
        "layout": "flow",
        "filename": "poster-connect-google-calendar-cursor.gif",
        "eyebrow": "BLOG / TUTORIAL",
        "headline": "Google Calendar MCP\nfor Cursor",
        "tagline": "Paste one JSON block into mcp.json and ask Cursor to list events, find free slots, and create meetings.",
        "badge": "5 MIN SETUP",
        "client_logo": "site/public/logos/cursor.svg",
        "tool_name": "Google Calendar",
        "tool_logo": "site/public/logos/google.svg",
        "tool_desc": "Connect Cursor to @mcp-wormhole/google-calendar — 12 tools, zero proxy, runs locally.",
        "auth_badges": [("OAuth", (34, 197, 94)), ("NPX", (255, 120, 64))],
        "card_stats": [("12", "TOOLS"), ("5 min", "SETUP")],
    },
    {
        "layout": "flow",
        "filename": "poster-inside-google-calendar-mcp.gif",
        "eyebrow": "BLOG / DEEP DIVE",
        "headline": "Inside Google Calendar\nMCP Server",
        "tagline": "12 tools, 6 prompt workflows, and browsable gcal:// resources — events, free/busy, RSVP.",
        "badge": "v0.1.0 LIVE",
        "client_logo": "site/public/logos/google.svg",
        "tool_name": "Google Calendar MCP",
        "tool_logo": "site/public/logos/google.svg",
        "tool_desc": "Calendars, events, search, free/busy, quick-add, RSVP — all exposed as MCP tools.",
        "auth_badges": [("OAuth", (34, 197, 94)), ("LIVE", (34, 197, 94))],
        "card_stats": [("12", "TOOLS"), ("6", "PROMPTS")],
    },
    {
        "layout": "flow",
        "filename": "poster-connect-linear-cursor.gif",
        "eyebrow": "BLOG / TUTORIAL",
        "headline": "Linear MCP\nfor Cursor",
        "tagline": "Paste one JSON block into mcp.json and ask Cursor to list issues, search your backlog, and create work.",
        "badge": "5 MIN SETUP",
        "client_logo": "site/public/logos/cursor.svg",
        "tool_name": "Linear",
        "tool_logo": "site/public/logos/linear.svg",
        "tool_desc": "Connect Cursor to @mcp-wormhole/linear — 14 tools, zero proxy, runs locally.",
        "auth_badges": [("API", (34, 197, 94)), ("NPX", (255, 120, 64))],
        "card_stats": [("14", "TOOLS"), ("5 min", "SETUP")],
    },
    {
        "layout": "flow",
        "filename": "poster-inside-linear-mcp.gif",
        "eyebrow": "BLOG / DEEP DIVE",
        "headline": "Inside Linear\nMCP Server",
        "tagline": "14 tools, 6 prompt workflows, and browsable linear:// resources — teams, issues, search, comments.",
        "badge": "v0.1.0 LIVE",
        "client_logo": "site/public/logos/linear.svg",
        "tool_name": "Linear MCP",
        "tool_logo": "site/public/logos/linear.svg",
        "tool_desc": "Teams, issues, search, workflow states, comments — all exposed as MCP tools.",
        "auth_badges": [("API", (34, 197, 94)), ("LIVE", (34, 197, 94))],
        "card_stats": [("14", "TOOLS"), ("6", "PROMPTS")],
    },
    {
        "layout": "flow",
        "filename": "poster-connect-cloudflare-cursor.gif",
        "eyebrow": "BLOG / TUTORIAL",
        "headline": "Cloudflare MCP\nfor Cursor",
        "tagline": "Paste one JSON block into mcp.json and ask Cursor to list zones, manage DNS, and purge cache.",
        "badge": "5 MIN SETUP",
        "client_logo": "site/public/logos/cursor.svg",
        "tool_name": "Cloudflare",
        "tool_logo": "site/public/logos/cloudflare.svg",
        "tool_desc": "Connect Cursor to @mcp-wormhole/cloudflare — 14 tools, zero proxy, runs locally.",
        "auth_badges": [("API", (34, 197, 94)), ("NPX", (255, 120, 64))],
        "card_stats": [("14", "TOOLS"), ("5 min", "SETUP")],
    },
    {
        "layout": "flow",
        "filename": "poster-inside-cloudflare-mcp.gif",
        "eyebrow": "BLOG / DEEP DIVE",
        "headline": "Inside Cloudflare\nMCP Server",
        "tagline": "14 tools, 6 prompt workflows, and browsable cf:// resources — zones, DNS, cache, Workers.",
        "badge": "v0.1.0 LIVE",
        "client_logo": "site/public/logos/cloudflare.svg",
        "tool_name": "Cloudflare MCP",
        "tool_logo": "site/public/logos/cloudflare.svg",
        "tool_desc": "Zones, DNS, cache purge, Workers, firewall — all exposed as MCP tools.",
        "auth_badges": [("API", (34, 197, 94)), ("LIVE", (34, 197, 94))],
        "card_stats": [("14", "TOOLS"), ("6", "PROMPTS")],
    },
]
